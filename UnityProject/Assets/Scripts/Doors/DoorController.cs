...
public class DoorController : NetworkBehaviour
{
		...
		public void PlayOpenSound()
		{
			if (openSFX != null)
			{
				...
				SoundManager.PlayAtPosition(openSFX, registerTile.WorldPosition, isGlobal: true, polyphonic: true);
			}
		}
		...
		public void PlayCloseSound()
		{
			if (closeSFX != null)
			{
				SoundManager.PlayAtPosition(closeSFX, registerTile.WorldPosition, polyphonic: true);
			}
		}
